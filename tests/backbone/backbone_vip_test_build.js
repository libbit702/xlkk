...
define('model/item',['backbone'], function(Backbone){
...
define('text!template/1.html',[],function () { return '啊啊啊尊贵的<%= type==3 ? "经济套餐" : "豪华套餐" %>用户,套餐到期时间：<%= date_expire %><span class="vip" style="font-family:sans-serif; color:blue; cursor:pointer;">[vip]</span><span class="jinji" style="font-family:sans-serif; color:blue; cursor:pointer;">[jinji]</span>';});

define('view/itemview',['backbone','model/item', 'underscore', 'jquery', 'vip', 'text!template/1.html'], function(Backbone,Item, _, $, vip, tpl){
  var baoyueUser = {
	daily:"15",
	expire:"2013-07-03",
	grow:"3570",
...
define('collection/list',['backbone','model/item'], function(Backbone,Item){
  return Backbone.Collection.extend({
	model: Item
  });  
});
define('view/listview',['backbone','model/item', 'underscore', 'jquery', 'vip', 'view/itemview', 'collection/list'], function(Backbone,Item, _, $, vip, ItemView, List){
  return Backbone.View.extend({    
...
require(["jquery", 'view/listview'], function($, ListView){	
	Backbone.$ = jQuery;
	var listView = new ListView(); 
});

define("backbone_vip_test", function(){});
