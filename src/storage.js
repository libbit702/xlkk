...
define(['domReady','json'], function(domReady, JSON){
    ...
    var StorageLite = {     
         ...
         * 取得storage存储的值
         *
         * @method module:storage.getItem
         * @param {String} key 存储用的key
         * @param {Boolean} json 是否使用json解析
         * @return {Object|String} storage中储存的key对应的值
         */  
         ...
         * 取得storage已存储值的数量
         *
         * @method module:storage.length
         * @return {Num} storage中已存储值的数量
         */  
         ...
         * 删除storage存储的key
         *
         * @method module:storage.removeItem
         * @param {String} key 存储用的key
         */  
         ...
         * 向storage添加存储项
         *
         * @method module:storage.setItem
         * @param {String} key 存储所用的key值
         * @param {Object|String} value 需要存储的值
         */  
