define(['cookie', 'minisite', 'eventutil'], function(c, m, et){
	...
	var commonIframe = {
		...
		commonIframePost : function(pcontent) {
			...
			thisPoint.postData(thisPoint.posturl,pdata,function(r){thisPoint.successCall(r)},pcontent);
		},
	...
	CommentShuoshuo.prototype = {
	    buildComment:function(){
	        ...
	        _self = this;
	        m.loadJSData(url,'utf-8', function(){
	        	_self.makeCommentHtml();
	        });
	    },  
        
        bindCommentIframe:function(c){
            commonIframe.cs = c;
        },
    ...
    et.addEventHandler($('postContent'), 'focus', function(){onAction(this,'focus','我来说两句')});
    et.addEventHandler($('postContent'), 'blur', function(){onAction(this,'blur','我来说两句')});
